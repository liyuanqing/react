...
class Community extends React.Component {
  ...
  constructor(props) {
    ...
    componentDidMount(){
         var { dispatch, community, layout} = this.props;
         //var poiId=layout.selectPoi;
         dispatch(actions.getCommunityList());
    }
    render() {
        var { dispatch, community } = this.props;
        return (
            ...
            <div className="content-search">
              ...
              <Table dataSource={community.list} columns={this.innercolumns} />
            </div>
