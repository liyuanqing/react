  ...
  render() {
    const columns = [{
      ...
      render: (text, record) => {
        ...
        return <div>
          <Popconfirm title={record.status==1?'确定要禁用该企业帐号吗？':'确定要启用该企业帐号吗？'} onConfirm={this.companyOpenDown.bind(this,text)}>
      ...
      <div className="page-content">
          ...
          <Form horizontal>
            <Row>
              <Col span={6}>
                ...
                {getFieldDecorator('property_name')(<Input type="text" placeholder="请输入企业名称"/>)}
                </FormItem>
              </Col>
              <Col span={6}>
        ...
        <Card className="mt1">
           <Link to="/estateCompanyAdd">
            <span><Button type="primary"><Icon type="plus" />新增企业</Button></span>
           </Link>
